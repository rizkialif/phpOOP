...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $kueri = "INSERT INTO arsip(judul, konten, gambar, tanggal_terbit, tanggal_edit)
              VALUES('$judul', '$konten', '$gambar', '$tanggal_terbit', '$tanggal_edit')";
    ...
    if ($hasil) {
        ...
        header('Location: daftar-arsip.php?sukses=tambah');
